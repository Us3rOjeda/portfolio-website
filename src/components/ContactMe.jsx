function ContactMe({ darkMode, isEnglish }) {
  return (
    <section id='contact-me' className={`${darkMode ? 'bg-[#1a1a1a]' : 'bg-white'} relative`}>
      <h1 className={`text-5xl m-6 sm:text-[150px] sm:m-10 font-times font-semibold ${darkMode ? 'text-[#e5e5e5]' : 'text-[#1a1a1a]'} toggle-color`}>{`${isEnglish ? 'Contact Me' : 'Contacto'}`}</h1>
